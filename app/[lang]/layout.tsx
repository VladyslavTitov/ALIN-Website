...
import '../globals.css';
export const metadata:Metadata={title:'ALIN · Zahnmedizin mit Gefühl',description:'Persönliche Beratung und verständliche Informationen zu moderner Zahnmedizin.',robots:{index:false,follow:false},icons:{icon:'/favicon.png',shortcut:'/favicon.png'}};
